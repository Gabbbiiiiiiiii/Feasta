...
class _CustomerDiscoveryScreenState extends State<CustomerDiscoveryScreen> {
  ...
  late final Future<List<ServiceCategory>> _serviceCategories;
  ...
  void initState() {
    ...
    _serviceCategories = _repository.getActiveServiceCategories();
    _serviceCategoryNames = _repository.getServiceCategoryNameMap();
  }
  ...
  Widget _buildContent() {
    return switch (widget.view) {
      CustomerDiscoveryView.categories => FutureBuilder<List<ServiceCategory>>(
        ...
        builder: (context, snapshot) {
          ...
          if (categories.isEmpty) {
            return const _DiscoveryMessage(
              ...
              message: 'There are no active service categories right now.',
            );
          }

          return _CategoryDiscoveryGrid(
            items: categories
                .map(
                  (category) => _DiscoveryCategory(
                    label: category.name,
                    query: category.name,
      ...
      CustomerDiscoveryView.recommendedCaterers => _ProviderDiscoveryList(
        ...
        categoryNames: _serviceCategoryNames,
...
class _ProviderDiscoveryList extends StatelessWidget {
  ...
  final Future<Map<String, String>> categoryNames;

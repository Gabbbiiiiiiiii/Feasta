import 'package:feasta/core/domain/service_category.dart';
      ...
      await tester.pumpWidget(
        _largeTextApp(
          ProviderRegisterScreen(
            serviceCategoryLoader: _loadTestServiceCategories,
          ),
        ),
      );
...
Future<List<ServiceCategory>> _loadTestServiceCategories() async {

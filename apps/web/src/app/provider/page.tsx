...
export default async function ProviderPage() {
  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="flex flex-wrap items-center gap-2" aria-label="Provider status"><span className="font-semibold">Verification:</span><StatusBadge status="approved" /></div>

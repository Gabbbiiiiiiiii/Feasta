...
export function ProviderDirectoryShell({
  children,
}: {
  children: ReactNode;
}) {
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-feasta-text-secondary sm:text-lg sm:leading-8">
                Browse approved public providers, compare the services they
                offer, and continue shaping your event through the FEASTA
                marketplace.
              </p>
            </div>

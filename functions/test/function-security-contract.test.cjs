...
const policies = [
  ...
  ["createPaymentSession", "payments/create-payment-session.ts", ["requireAuth(request)", "requireRole", "enforceCallableRateLimit", "appCheckCallableOptions", "defineSecret", "rejectUnknownFields", "parseCustomerPaymentChoice", "paymentIdForProviderRequestChoice", "providerPaymentObligationForChoice", "initialPaymentSelectionReason", "paymentIdForProviderRequest", "canonicalPaymentLinkageReason", "providerOperationalReason", "payMongoFailureCertainty", "calculateMainEventRequestSummary", "runTransaction"]],
